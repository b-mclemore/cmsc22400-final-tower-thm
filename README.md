...
This project owes a great deal of its initial framework (almost all of the VectorAxioms module) to the work done by Quinn Dougherty on his YouTube series "Linear Algebra Done Right In Coq". I would not have been able to formalize Vector Spaces without this series, so I would consider the VectorAxioms module as more of an external library than my own work.
