...
Here's a basic outline of the theorem's we'll want in order to prove the Tower Theorem:

1. If L/K is a field extension, then L is also a K-vector space
2. The degree [L : K] is equal to the cardinality of the basis of L as a K-vector space
3. If K3 is a K2-VS, and K2 is a K1-VS, then K3 is a K1-VS whose basis has cardinality equal to the product of the bases of K3 as a K2-VS and K2 as a K1-VS

This project owes a great deal of its initial framework (a majority of the VectorFields file) to the work done by Quinn Dougherty on his YouTube series "Linear Algebra Done Right In Coq". I would not have been able to formalize Vector Spaces without this series.
